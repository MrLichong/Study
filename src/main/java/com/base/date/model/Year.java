...
public class Year {
	...
	public String toString() {
		return "Year{startDay='" + this.startDay + '\'' + ", startDay13Time=" + this.startDay13Time + ", " +
				"startDay10Time=" + this.startDay10Time + ", lastDay='" + this.lastDay + '\'' + ", lastDay13Time=" +
				this.lastDay13Time + ", lastDay10Time=" + this.lastDay10Time + ", monthStartDay=" + this
				.monthStartDay + ", monthStartDay13Time=" + this.monthStartDay13Time + ", monthStartDay10Time=" +
				this.monthStartDay10Time + '}';
	}
}

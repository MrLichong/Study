...
public class DateEnhance {
	...
	public String toString() {
		return "DateEnhance{year=" + this.year + ", lastYear=" + this.lastYear + ", month=" + this.month + ", " +
                "lastMonth=" + this.lastMonth + ", last2Month=" + this.last2Month + ", week=" + this.week + ", " +
                "lastWeek=" + this.lastWeek + ", last2Week=" + this.last2Week + ", day=" + this.day + '}';
	}

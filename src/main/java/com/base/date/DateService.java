...
public class DateService {
	...
	static String getStartDayOfWeek(LocalDate localDate, String pattern, int adjust) {
		...
		return localDate.with(WeekFields.of(Locale.CHINA).dayOfWeek(), (long) adjust).atStartOfDay(ZoneId
                .systemDefault()).plusDays(1L).format(DateTimeFormatter.ofPattern(pattern));
	}
